...
static void alc_fixup_disable_automute(struct hda_codec *codec,
				       const struct hda_fixup *fix, int action)
{
        struct alc_spec *spec = codec->spec;
...
static const struct hda_fixup alc269_fixups[] = {
	...
	[ALC233_FIXUP_LG_GENOVA] = {
		.type = HDA_FIXUP_FUNC,
		.v.func = alc_fixup_disable_automute,
		.chained = true,
...
static const struct snd_pci_quirk alc269_fixup_tbl[] = {
	SND_PCI_QUIRK(0x1854, 0x0315, "LG Electronics GENOVA", ALC233_FIXUP_LG_GENOVA),
...
#ifdef CONFIG_WHALEBOOK
	SND_PCI_QUIRK_VENDOR(0x1854, "LG Electronics", ALC233_FIXUP_LG_GENOVA),
#endif
...
static const struct hda_model_fixup alc269_fixup_models[] = {
	...
	{.id = ALC233_FIXUP_LG_GENOVA, .name = "alc233-lg-14u390"},
	{}
};
